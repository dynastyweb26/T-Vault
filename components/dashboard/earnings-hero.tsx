...
export function EarningsHero({ data }: EarningsHeroProps) {
  ...
  return (
    <section
      data-tour="dashboard-revenue"
      className="tv-feed-card tv-metallic-gold tv-gold-glow relative mx-5 flex aspect-[4/5] flex-col items-center justify-center overflow-hidden rounded-[20px]"
    >
