...
const JOBS_SELECT =
  "id, job_name, status, load_value, miles, delivery_date, payment_received_date, updated_at, invoice_generated, invoice_url, invoice_number, invoice_sent_date, broker_name, pickup_location, delivery_location";

const EXPENSES_SELECT =
  "id, job_id, amount, category, expense_date, created_at, description, receipt_url";
